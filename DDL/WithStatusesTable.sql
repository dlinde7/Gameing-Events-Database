...
PRIMARY KEY (`id`),
KEY `fkUserId` (`userId`),
CONSTRAINT `FK_USER_ID_ACCESS` FOREIGN KEY `fkUserId` (`userId`) REFERENCES `users` (`id`),
KEY `fkEmailVerifiedStatus` (`emailVerifiedStatus`),
CONSTRAINT `FK_EMAIL_VERIFIED_STATUS` FOREIGN KEY `fkEmailVerifiedStatus` (`emailVerifiedStatus`) REFERENCES `statuses` (`id`),
KEY `fkContactNumberVerifiedStatus` (`contactNumberVerifiedStatus`),
CONSTRAINT `FK_CONTACT_NUMBER_VERIFIED_STATUS` FOREIGN KEY `fkContactNumberVerifiedStatus` (`contactNumberVerifiedStatus`) REFERENCES `statuses` (`id`),
KEY `fkAdminPrivilagesStatus` (`adminPrivilagesStatus`),
CONSTRAINT `FK_ADMIN_PRIVILAGES_STATUS` FOREIGN KEY `fkAdminPrivilagesStatus` (`adminPrivilagesStatus`) REFERENCES `statuses` (`id`),
KEY `fkIsActiveStatus` (`isActiveStatus`),
CONSTRAINT `FK_IS_ACTIVE_STATUS_ACCESS` FOREIGN KEY `fkIsActiveStatus` (`isActiveStatus`) REFERENCES `statuses` (`id`)
);
...
KEY `fkIsActiveStatus` (`isActiveStatus`),
CONSTRAINT `FK_IS_ACTIVE_STATUS_ADDRESSDETAILS` FOREIGN KEY `fkIsActiveStatus` (`isActiveStatus`) REFERENCES `statuses` (`id`)
);
...
KEY `isQualifeidStatus` (`isQualifiedStatus`),
CONSTRAINT `FK_IS_QUALIFIED_EVENTREG` FOREIGN KEY `isQualifeidStatus` (`isQualifiedStatus`) REFERENCES `statuses` (`id`),
KEY `fkIsVerifiedStatus` (`isVerifiedStatus`),
CONSTRAINT `FK_IS_VERIFIED_STATUS_EVENTREG` FOREIGN KEY `fkIsVerifiedStatus` (`isVerifiedStatus`) REFERENCES `statuses` (`id`)
);
...
KEY `fkEventStatus` (`eventStatus`),
CONSTRAINT `FK_EVENT_STATUS` FOREIGN KEY `fkEventStatus` (`eventStatus`) REFERENCES `statuses` (`id`)
);
...
PRIMARY KEY (`id`),
KEY `fkReceiveNotificationsStatus` (`receieveNotificationsStatus`),
CONSTRAINT `FK_RECEIVEN_NOTIF_STATUS` FOREIGN KEY `fkIdx_655` (`receieveNotificationsStatus`) REFERENCES `statuses` (`id`)
);
...
KEY `fkIsActiveStatus` (`isActiveStatus`),
CONSTRAINT `FK_IS_ACTIVE_USERTEAMS` FOREIGN KEY `fkIsActive` (`isActiveStatus`) REFERENCES `statuses` (`id`),
KEY `fkEditPrivilagesStatus` (`editPrivilagesStatus`),
CONSTRAINT `FK_EDIT_PRIVILAGES_USERTEAMS` FOREIGN KEY `fkEditPrivilagesStatus` (`editPrivilagesStatus`) REFERENCES `statuses` (`id`),
KEY `fkTeamCaptainStatus` (`teamCaptainStatus`),
CONSTRAINT `FK_TEAM_CAPTAIN_STATUS` FOREIGN KEY `fkTeamCaptainStatus` (`teamCaptainStatus`) REFERENCES `statuses` (`id`)
);
...
KEY `fkIsActiveStatus` (`isActiveStatus`),
CONSTRAINT `FK_IS_ACTIVE_STATUS_VENUES` FOREIGN KEY `fkIsActiveStatus` (`isActiveStatus`) REFERENCES `statuses` (`id`)
);
